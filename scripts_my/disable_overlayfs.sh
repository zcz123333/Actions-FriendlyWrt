...
sed -i '/platform_copy_config/,+10 s/export_partdevice partdev 1/export_partdevice partdev 8/' friendlywrt/build_dir/target-aarch64_generic_musl/root-rockchip/lib/upgrade/platform.sh
